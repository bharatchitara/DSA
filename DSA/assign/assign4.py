...
#         
#     def sort_players_based_on_experience():
#         
#         
#     def display_players_details(self):
#         for lst in players_list:
#             print(lst)
#     
#     
#     
...
# g1.shift_players_to_new_position(1, 4)
# g1.display_players_details()
...
class Game:
    ...
    def sort_players_based_on_experience(self):
        self.__players_list.sort(key=lambda x:get_experience())
    def shift_players_to_new_position(self, old_index_position, new_index_position):
